...
#ifndef MANIPULATORCOMMONTEST_H
#define MANIPULATORCOMMONTEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  ManipulatorCommonTest(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void ManipulatorCommonTestInit(RTC::Manager* manager);
};

#endif // MANIPULATORCOMMONTEST_H
